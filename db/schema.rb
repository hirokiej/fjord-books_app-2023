...
ActiveRecord::Schema[7.0].define(version: 2024_08_14_084820) do
  ...
  add_foreign_key "mentions", "rports", column: "mentioned_report_id"
  add_foreign_key "mentions", "rports", column: "mentioning_report_id"
